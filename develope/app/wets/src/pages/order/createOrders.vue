<template>
    <view>
        <!-- 地址 -->
        <navigator :url="'/pages/address/addresss?source=1&isCustomAddress=' + data[0].isCustomAddress + '&cguid=' + data[0].cguid + '&customAddress=' + data[0].customAddress + '&postkind=' + this.postkind" class="address-section">
        ...
        <view class="tips">友情提示:优惠券、活动不能组合只用哦</view>
        <view class="yt-list">
            <!-- 优惠明细 -->
                    ...
                    if (this.tip.isaddresstip && this.popupState) {
                        ...
                        uni.showModal({
                            ...
                            success: res => {
                                ...
                                if (res.confirm) {
                                    uni.navigateTo({
                                        url: '/pages/address/addresss?source=1&postkind=' + this.postkind
                                    });
                                }
                            }
                        });
