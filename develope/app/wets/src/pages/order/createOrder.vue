<template>
    <view>
        <!-- 地址 -->
        <navigator :url="'/pages/address/address?source=1&isCustomAddress=' + data[0].isCustomAddress + '&cguid=' + data[0].cguid + '&customAddress=' + data[0].customAddress + '&postkind=' + this.postkind" class="address-section">
            ...
            <view class="tips">(为减少接触, 您可以在收货详细地址后增加如小区名称等)</view>
            <image
                class="a-bg"
