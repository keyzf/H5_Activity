    ...
    export default {
        ...
        methods: {
            ...
            /* uploadimg_axios(base64, fileName) {
                ...
                formData.append('token', "Ge60ZHZknUGLzz28vKMdpd32UYsd4IX5NVe4kbUs:bjsW20l5c_UKIxFrlhtTL3cAUkc=:eyJkZWFkbGluZSI6MTU3ODY1MTA0MSwic2NvcGUiOiJtYWxsLXN0b3JlIn0=");
                uni.showLoading({
                    title: '上传中..'
                });
                this.$axios.post("http://upload-z1.qiniup.com/", formData, {
                    headers: {
                    ...
                    k.push({
                        path: base64,
                        url: "http://mallstore.holdsoft.cn/" + res.data.key
                    });
            ...
            addShopProductStep2() {
                ...
                for (let i = 0; i < this.imageList.length; i++) {
                    if(this.imageList[i].url != undefined && this.imageList[i].url != "" ){
                        ...
                        img_tmp.push(this.imageList[i].url)
                    }
