    ...
    <view class="content">
        <view class="con" :style="{ position: headerPosition, top: headerTop }">
            <view class="search-box">
                ...
                <view class="input-box" @tap="returngo()"><input type="text" :placeholder="keyword" placeholder-class="placeholder-class" confirm-type="search" disabled /></view>
...
export default {
    ...
    methods: {
        ...
        navToDetailPage(id) {
            uni.navigateTo({
                url: '/pages/product/assemble-product?productid=' + id
            });
        },
        navToShop(id) {
            uni.navigateTo({
