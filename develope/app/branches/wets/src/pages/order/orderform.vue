  ...
  <view>
      ...
      <view class="uni-list">
        ...
        <radio-group @change="radioChange">
          <label class="uni-list-cell uni-list-cell-pd" v-for="(item, index) in refundForm.goodssattelist" :key="index">
            ...
            <view>
              <radio :checked="item.isdefault == 1" :value="'goodsstate_' + item.goodssatte" />
            </view>
          </label>
        </radio-group>
      </view>
    ...
    <view class="yt-list">
      <view class="uni-list">
        ...
        <radio-group @change="radioChange">
          <label class="uni-list-cell" v-for="(item, index) in (refundtype == 0 ? refundForm.refundreasonlist : refundForm.refundreasonlistother)"
            :key="index">
            <view class="optin">{{ item.content }}</view>
            <view>
              <radio :checked="item.isdefault == 1" :value="'refundreason_' + item.refundreason" />
            </view>
          </label>
        </radio-group>
      </view>
    ...
    <view class="yt-list">
      <view class="yt-list-cell b-b">
        ...
        <input class="desc" type="number" :placeholder="refundForm.maxrefundnumstr" v-model="refundForm.maxrefundnum"
...
<script>
  export default {
    ...
    methods: {
      ...
      // 获取退款表单详情
      getRefundForm() {
        this.$ajax.get('order/choserefundtype', {
