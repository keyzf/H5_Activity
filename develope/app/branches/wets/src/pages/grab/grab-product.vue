<template>
    <view class="container" :class="{ over: overf }">
        ...
        <view class="page-bottom" v-if="showtab && data.productkind != 4">
            ...
            <view class="action-btn-group" v-if="data.isuse == 0">
...
export default {
    ...
    methods: {
        ...
        switchaddress() {
            uni.navigateTo({
                url: '/pages/address/address?source=1&cguid=' + this.data.companyGuid + '&isCustomAddress=' + this.data.isCustomAddress + '&customAddress=' + this.data.customAddress
            });
        },
        // 切换地址
        updateOrderAddress() {
