    ...
    <view class="content">
        <view class="con" :style="{ position: headerPosition, top: headerTop }">
            <view class="search-box">
                ...
                <view class="input-box" @tap="returnSearch()"><input type="text" :placeholder="keyword" placeholder-class="placeholder-class" confirm-type="search" disabled /></view>
                        ...
                        <view class="cons">
                            ...
                            <view class="clamp" style="flex-grow: 1;">
                                <view class="pcice">
                                    ...
                                    <text v-if="item.newactivitylist.length == 0" class="tip">{{ item.sales }}</text>
                                    <block v-else>
                                        <text class="active" v-for="ite in item.newactivitylist" :key="ite.wholetext" :style="{color:ite.color,borderColor:ite.color}">{{ ite.wholetext }}</text>
                                    </block>
                                </view>
                ...
                <scroll-view scroll-y class="cate-list">
                    <view v-for="(item, index) in cateList" :key="index">
                        ...
                        <view class="cate-item-lists" :class="{ open: item.active }">
                            <text v-for="tItem in item.list" :key="tItem.filtertype" class="cate-item-list" :class="{ active: tItem.selet }" @click="changeCate(tItem, index)">
                                {{ tItem.filtertext }}
                            </text>
                        </view>
                    </view>
