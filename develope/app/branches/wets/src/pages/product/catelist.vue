<template>
    <view class="page-content">
        <view class="nav-head">
            ...
            <view class="nav-bd"><view class="uni-page-head__title">{{navtitle}}</view></view>
        ...
        <luBarTabNav :tabList="tabList" :barFixed="barFixed" :barHeight="barHeight" :barTop="barTop" :barId="barId" ref="barTabNav">
            <view v-for="(item, index) in list.tabs" :key="index" :id="'item' + (index + 1)">
                ...
                <view class="goods-list">
                    <view class="goods-item" @click="navToDetailPage(items.productid)" v-for="(items, indexs) in item.productlist" :key="indexs">
                        ...
                        <view class="item-con">
                            ...
                            <view class="price-box clamp">
                                ...
                                <view v-else>
                                    <text v-for="(ite,nex) in items.activitylist" :key="ite.wholetext+ite.color+nex" :style="{color:ite.color,borderColor:ite.color}">{{ ite.wholetext }}</text>
                                </view>
                            </view>
                            <view class="clamp">
                                <view class="typename">
                                    <block v-if="items.selficon.url"><image :src="items.selficon.url" mode="aspectFit"></image></block>
                ...
                <view v-for="(item, index) in goodsList" :key="index" class="goods-item" @click="navToDetailPage(item.productid)">
                    ...
                    <view class="item-con">
                        ...
                        <view class="price-box clamp">
                            ...
                            <view v-else>
                                <text v-for="(ite,nex) in item.activitylist" :key="ite.wholetext+ite.color+nex" :style="{color:ite.color,borderColor:ite.color}">{{ ite.wholetext }}</text>
                            </view>
                        </view>
                        <view class="clamp">
                            <view class="typename">
