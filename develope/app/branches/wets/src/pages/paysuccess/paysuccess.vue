    ...
    <view class="recommend">
      ...
      <view class="goods">
        <view class="goodsitem" v-for="(item,index) in goods" :key='index'>
          <goodsItemTwo :produceid='item.productid' :mainpic='item.url' :actimgurl='item.newOnShelvesProductIcon'
            :goodDes='item.feature_short' :tag='item.selftext' :goodTitle='item.name' :goodPrice='item.price'
            :bottomtag="item.activitylist" @clickGoodDetail='goodsdetail'></goodsItemTwo>
        </view>
      </view>
    </view>
  </view>
