  ...
  <view class="content">
    <view class="search-box">
      ...
      <view class="input-box">
        <input type="text" :placeholder="defaultKeyword" v-model="keyword" @confirm="doSearch(false)" placeholder-class="placeholder-class"
          confirm-type="search">
      </view>
  ...
  export default {
    ...
    methods: {
      ...
      inputChange(event) {
        ...
        this.$ajax.get('search/searchSuggest', {
          keyword: keyword
        }).then(res => {
