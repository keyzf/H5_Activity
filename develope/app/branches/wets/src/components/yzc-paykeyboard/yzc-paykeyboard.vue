<template>
	<view>
		...
		<view :class="['content', show ? '' : 'contenthide']">
			<view class="title">
				<view class="close" @click="close()"><image src="../../static/closejp.png" /></view>
				<view class="center">请输入 餐卡 密码</view>
		...
		<view :class="['keyboard', show ? '' : 'active', isIphoneX ? 'isIphone' : '']">
			...
			<view class="keyboard-item delte" @tap="del()"><image class="img" src="../../static/deljp.png" mode="aspectFill" :lazy-load="true"></image></view>
		</view>
