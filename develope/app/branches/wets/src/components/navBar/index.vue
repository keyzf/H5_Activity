<template>
    <view>
        <view
            ...
            :style="{ paddingTop: statusBarHeight + 'px', background: navBgColor, color: navFontColor}"
        >
            <view class="left_box" @click="searchs">
                <slot name="left">
                ...
                <view class="title" :style="{  opacity: transparentValue }">
        ...
        <view
            ...
            :style="{ paddingTop: statusBarHeight + 'px', color: navTransparentFixedFontColor, zIndex: transparentValue < 0.3 ? 100 : 90 }"
        >
            <view class="left_box" @click="searchs">
                ...
                <view class="title">
                    <slot name="transparentFixedTitle" :style="{  opacity: 1 - transparentValue }"></slot>
                </view>
            </view>
        ...
        if (this.type == 'transparentFixed') {
            ...
            currentPages[pageLen - 1].onPageScroll = function(e) {
                ...
                if (e.scrollTop > 80) {
                    ...
                    _this.transparentValue = e.scrollTop / 80;
                }
            };
            // #endif
            // #ifdef H5
            window.onscroll = function(e) {
                ...
                if (scrollTop > 80) {
                    ...
                    _this.transparentValue = scrollTop / 80;
                }
            };
            // #endif
        }
